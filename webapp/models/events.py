...
class EventClass(db.Model):
    ...
    default_maximal_group_count = db.Column(db.Integer())
    proximity_prefer_group_count_over_proximity = db.Column(db.Integer())
    proximity_uses_percentage_instead_of_absolute = db.Column(db.Boolean())
